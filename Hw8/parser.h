...
//these are used to determine which message its identified at the moment 
//the bytes are put  together and checksum is okay. 
#define A	"GPGGA"  
#define B	"GPGSA" 
#define C	"GPRMC" 
#define D	"GPGSV" 
...
//VARIABLES OF GPGGA
	...
	int position_fix; //se the position fix 
									/*Value Description
	...
	int satelites_A;  //number of satellites in the fix 
	string sat_used;
	...
	double geoidSeperation; //goid-to-ellipsoid separation Ellipsoid altitude=MLS altitude +Geoid Separation 
	string age;
